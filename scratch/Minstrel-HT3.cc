...
int main() {
 ...
 // Setup AP
   ...
   // Save the throughput data to the throughput CSV file
    std::ofstream throughputFile("throughput_vs_distance_sta2_Minstrel-k" + std::to_string(distance) + ".csv", std::ios::app);
   ...
   std::ofstream packetLossFile("packet_loss_vs_distance_sta2_Minstrel-k" + std::to_string(distance) + ".csv", std::ios::app);
