...
int main() {
   ...
   // Save the throughput data to the throughput CSV file
    std::ofstream throughputFile("throughput_vs_distance_sta2_Thompson-b" + std::to_string(distance) + ".csv", std::ios::app);
   ...
   std::ofstream packetLossFile("packet_loss_vs_distance_sta2_Thompson-b" + std::to_string(distance) + ".csv", std::ios::app);
